...
func boolSetting(source, param string, ok bool) string {
	return fmt.Sprintf(msql.CDSNFormat, source, param, strconv.FormatBool(ok))
}
...
func timeSetting(source, param string, t time.Duration) string {
	...
	return fmt.Sprintf(msql.CDSNFormat, source, param, t)
}
...
func stringSetting(source, param, value string) string {
	...
	return fmt.Sprintf(msql.CDSNFormat, source, param, value)
}

// SetCharset Sets the charset used for client-server interaction
func SetCharset(v string) msql.Setting {
...
func SetLoc(v string) msql.Setting {
	return func(source string) string {
...
func SetCollation(v string) msql.Setting {
	return func(source string) string {
...
func SetAllowCleartextPasswords(ok bool) msql.Setting {
	return func(source string) string {
...
func SetAllowNativePasswords(ok bool) msql.Setting {
	return func(source string) string {
...
func SetAutoCommit(ok bool) msql.Setting {
	return func(source string) string {
...
func SetParseTime(ok bool) msql.Setting {
	return func(source string) string {
...
func SetAllowAllFiles(ok bool) msql.Setting {
	return func(source string) string {
...
func SetClientFoundRows(ok bool) msql.Setting {
	return func(source string) string {
...
func SetColumnsWithAlias(ok bool) msql.Setting {
	return func(source string) string {
...
func SetInterpolateParams(ok bool) msql.Setting {
	return func(source string) string {
...
func SetStrict(ok bool) msql.Setting {
	return func(source string) string {
...
func SetTimeout(timeout time.Duration) msql.Setting {
	return func(source string) string {
...
func SetReadTimeout(timeout time.Duration) msql.Setting {
	return func(source string) string {
...
func SetWriteTimeout(timeout time.Duration) msql.Setting {
	return func(source string) string {
		return timeSetting(source, "writeTimeout", timeout)
	}
}

func GetSettingFunctionList(dynamicConfigure *msql.DynamicConf) []msql.Setting {
	return []msql.Setting{
		SetCharset("utf8mb4"),
		SetCharset("utf8mb4"),
